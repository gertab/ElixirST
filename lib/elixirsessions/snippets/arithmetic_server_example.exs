...
inferred_session_type = [
  branch: %{
    add: [recv: 'type', send: 'type'],
    neg: [recv: 'type', send: 'type']
  }
]
                   ...
                   do: [
                     {:->, [line: 17],
                      [
                        ...
                        {:__block__, [],
                         [
                           {{:., [line: 18], [{:__aliases__, [line: 18], [:IO]}, :puts]},
                            [line: 18],
                            [
                              {:<<>>, [line: 18],
                               [
                                 ...
                                 {:"::", [line: 18],
                                  [
                                    {{:., [line: 18], [Kernel, :to_string]}, [line: 18],
                                     [{:num1, [line: 18], nil}]},
                                    {:binary, [line: 18], nil}
                                  ]},
                                 " + ",
                        ...
                        {:__block__, [],
                         [
                            ...
                            [
                              {:<<>>, [line: 25],
                               [
                                 ...
                                 {:"::", [line: 25],
                                  [
                                    {{:., [line: 25], [Kernel, :to_string]}, [line: 25],
                                     [{:num, [line: 25], nil}]},
                                    {:binary, [line: 25], nil}
                                  ]}
                               ]}
                           ...
                           {:send, [line: 26],
                            [
                              {:pid, [line: 26], nil},
                              {:{}, [line: 26], [{:-, [line: 26], [{:num, [line: 26], nil}]}]}
                            ]}
                         ]}
                      ]}
                   ]
